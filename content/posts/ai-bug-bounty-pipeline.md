...
draft = false
title = 'Hands-on: Earning Bug Bounties with AI-Driven Automated Vulnerability Hunting (Part 1)'
...
I scripted the pipeline above and ran it against a TSRC target's subdomains as a test. It turned up a postMessage-based arbitrary JavaScript code execution bug, and that earned me a bounty worth around $450.
